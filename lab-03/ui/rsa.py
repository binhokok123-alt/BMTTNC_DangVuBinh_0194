...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_plain_text.setGeometry(QtCore.QRect(90, 120, 211, 71))
        ...
        self.txt_cipher_text.setGeometry(QtCore.QRect(90, 260, 211, 71))
        self.txt_cipher_text.setObjectName("txt_cipher_text")
        self.btn_encrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_encrypt.setGeometry(QtCore.QRect(90, 360, 75, 23))
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(230, 360, 75, 23))
        self.btn_decrypt.setObjectName("btn_decrypt")
        self.txt_sign = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_sign.setGeometry(QtCore.QRect(530, 120, 241, 71))
        self.txt_sign.setObjectName("txt_sign")
        self.txt_verify = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_verify.setGeometry(QtCore.QRect(530, 270, 241, 71))
        self.txt_verify.setObjectName("txt_verify")
        self.btn_gen_keys = QtWidgets.QPushButton(self.centralwidget)
        self.btn_gen_keys.setGeometry(QtCore.QRect(560, 70, 111, 23))
        self.btn_gen_keys.setObjectName("btn_gen_keys")
        self.btn_sign = QtWidgets.QPushButton(self.centralwidget)
        self.btn_sign.setGeometry(QtCore.QRect(530, 360, 75, 23))
